...
class Orders extends OrderQuery
{
    ...
    {
        $configs = $this->p21->getConfigValue(['cono', 'whse', 'p21customerid', 'invstartdate']);
        extract($configs);
        ...
        $ordersList = $this->p21->SalesOrderList($cono, $customer['p21_custno'], "", "", "N", "", $invstartdate, $invenddate, "N");
