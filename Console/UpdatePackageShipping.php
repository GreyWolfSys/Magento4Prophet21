...
class UpdatePackageShipping extends Command
{
    protected $logger;
    ...
    {
        $this->setName('P21Pricing:updatePackageShipping');
        $this->setDescription('Update Package Shipping');
...
////don't need invoices in place for this
                            ...
                            $this->p21->gwLog("test1: " . json_encode($row));
                            $this->p21->gwLog("test2: " . json_encode($gcOrder));
                            if (isset($gcOrder)) {
                            ...
                            $this->p21->gwLog("test3: " . json_encode($gcpackage));
                        ...
                        if ($order->hasInvoices() ) {
                                        ...
                                        foreach ($order->getInvoiceCollection() as $invoice) {
                                            try {
                                                ...
                                                foreach ($order->getAllItems() as $orderItem) {
                                                    ...
                                                    $this->p21->gwLog("test4: " . json_encode($gcLines));
                                                    if (isset($gcLines)) {
                            ...
                            if ($checkstage == true) {
                                ...
                                if (isset($gcOrder)) { //
                                    if (isset($gcOrder["cono"]) && $gcOrder["cono"] != "0") {
                                        $item = $gcOrder;
